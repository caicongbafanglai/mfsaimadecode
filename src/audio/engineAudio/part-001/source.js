...
const WARNING_CUES = new Set(['LOW ENERGY', 'OVERSPEED', 'STALL', 'A.FLOOR', 'RETARD', 'REV LOCKED', 'LVR ASYM', 'FLAP OVERSPEED', 'TOO FAST FOR FLAPS']);
...
export function createEngineAudioSystem({ state }) {
  ...
  function update(deltaTime = 1 / 60) {
    ...
    const speedKts = Math.abs(state.speed || 0) * 1.94384;
